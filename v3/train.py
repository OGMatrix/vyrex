...
def train(config: VyrexConfig, resume: bool = False):
        ...
        if checkpoint_load_dir:
            ...
            try:
                ...
                if os.path.exists(bk_path):
                    ...
                    # Check for missing wandb_run_id
                    if "wandb_run_id" not in bk or not bk.get("wandb_run_id"):
                        missing_wandb_run_id = True
        else:
    ...
    if checkpoint_load_dir:
        ...
        # If wandb_run_id is missing, force new WandB run
        if missing_wandb_run_id:
